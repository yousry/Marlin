...
#define STRING_CONFIG_H_AUTHOR "(Yousry Abdallah, SKR1.4 Kossel)" // Who made the changes.
...
//#define CUSTOM_MACHINE_NAME "Kossel SKR1.4"
...
#define DELTA
  ...
  #define DELTA_HEIGHT 247.9 // (mm) Get this value from G33 auto calibrate
