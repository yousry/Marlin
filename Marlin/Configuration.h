...
#define STRING_CONFIG_H_AUTHOR "(Yousry, Kossel SKR 1.4 Turbo)" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "Kossel SKR 1.4 Turbo"

// Printer's unique ID, used by some programs to differentiate between machines.
// Choose your own or use a service like https://www.uuidgenerator.net/version4
#define MACHINE_UUID "140538af-08ff-4733-a1a4-cd0fd670dda3"
...
#define PID_K1 0.95      // Smoothing factor within any PID loop
  ...
  // M301: p:25.8100 i:2.2400 d:74.3100
  ...
  #else
    #define DEFAULT_Kp  25.81
    #define DEFAULT_Ki   2.24
    #define DEFAULT_Kd  74.31
  #endif
#endif // PIDTEMP
...
#define MAX_BED_POWER 255 // limits duty cycle to bed; 255=full current
  ...
  // M304: p:168.6600 i:25.9800 d:729.9001

  #define DEFAULT_bedKp 168.66
  #define DEFAULT_bedKi  25.98
  #define DEFAULT_bedKd 729.90
...
#define DELTA
  ...
  #define DELTA_HEIGHT 246.61             // (mm) Get this value from G33 auto calibrate

  #define DELTA_ENDSTOP_ADJ { 0.0, 0.0, 0.0 } // Get these values from G33 auto calibrate

  // Horizontal distance bridged by diagonal push rods when effector is centered.
  #define DELTA_RADIUS 143.59              // (mm) Get this value from G33 auto calibrate

  // Trim adjustments for individual towers
  // tower angle corrections for X and Y tower / rotate XYZ so Z tower angle = 0
  // measured in degrees anticlockwise looking from above the printer
  #define DELTA_TOWER_ANGLE_TRIM { -0.26, 0.10, 0.15 } // Get these values from G33 auto calibrate
...
#define MEASURED_TITAN_EXTRUDER 398


// delta speeds must be the same on xyz
#define DEFAULT_XYZ_STEPS_PER_UNIT ((XYZ_FULL_STEPS_PER_ROTATION) * (XYZ_MICROSTEPS) / double(XYZ_BELT_PITCH) / double(XYZ_PULLEY_TEETH))
#define DEFAULT_AXIS_STEPS_PER_UNIT   { DEFAULT_XYZ_STEPS_PER_UNIT, DEFAULT_XYZ_STEPS_PER_UNIT, DEFAULT_XYZ_STEPS_PER_UNIT, MEASURED_TITAN_EXTRUDER }  // default steps per unit for Kossel (GT2, 20 tooth)
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { 0, 22, -0.34 }
